...
if TYPE_CHECKING:
    from firestore_sessions import SessionStore
...
class RAG:
    ...
    def __init__(
        ...
        # Session store — injected by server.py.
        # Falls back to a private in-memory dict if none provided
        # (e.g. when RAG is instantiated directly in tests or scripts).
